...
from ml.stacking.FileExtensionDataModule import FileExtensionDataModule
from ml.util import *
from ml.visualize import validate


class FileExtensionDataSVM(FileExtensionDataModule):
    name = "FileExtensionDataSVM"

    def __init__(self, max_samples_per_category = 210, dev_size=0.5, test_size=0.1, labeled_data_filter=None):
        super(FileExtensionDataSVM, self).__init__(max_samples_per_category, dev_size, test_size, labeled_data_filter)
        self.run()
